...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success({ title: "Account created", description: "Welcome to NoteVerse." });
      router.push("/home");
    } catch (err: any) {
      setError(err.message);
      toast.error({ title: "Signup failed", description: err.message || "Please try again." });
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md">
        ...
        <motion.div
          ...
          className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-200/50 overflow-hidden"
        >
          <div className="p-8">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-2">Join NoteVerse</h2>
            ...
            <div className="space-y-4 mb-8">
              <button
                onClick={() => {
                  toast.info({ title: "Redirecting to Google", description: "Continue signup in the provider window." });
              ...
              <button
                onClick={() => {
                  toast.info({ title: "Redirecting to GitHub", description: "Continue signup in the provider window." });
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
          <div className="p-4 bg-white/50 backdrop-blur-sm rounded-xl border border-gray-200/50">
            ...
            <p className="text-sm font-medium text-gray-700">Secure & Encrypted</p>
          </div>
          ...
          <div className="p-4 bg-white/50 backdrop-blur-sm rounded-xl border border-gray-200/50">
            ...
            <p className="text-sm font-medium text-gray-700">Always Free</p>
          </div>
